...
export const DISEASE_LANDINGS: DiseaseLanding[] = [
    {
        ...
        tagline: "急性骨髓性白血病 (AML) — 又稱「血癌」之一，是成人最常見的急性白血病，近年因 FLT3、Menin、BCL-2 等標靶治療進展而大幅改善預後。",
        ...
        treatmentContext: "AML 治療在過去 10 年大幅進展。FLT3 抑制劑 (Midostaurin、Quizartinib、Gilteritinib) 改善 FLT3 突變病患的預後；IDH1/2 抑制劑針對 IDH 突變病患；Venetoclax (BCL-2 抑制劑) 合併低甲基化藥物已成為不適合密集化療病患的標準治療；Menin-KMT2A 抑制劑 (Bleximenib、Enzomenib) 為 KMT2A 重組或 NPM1 突變患者帶來新希望。",
    },
    {
        slug: "MDS",
        nameZh: "骨髓增生不良症候群",
        ...
        tagline: "骨髓增生不良症候群 (MDS) — 骨髓造血功能異常的一群疾病，部分病患會進展為 AML。治療策略依風險分群、突變特徵與輸血依賴程度量身設計。",
        ...
        treatmentContext: "低度與中度風險 MDS 主要目標是改善輸血依賴、減少貧血症狀，常用藥物包括紅血球生成素 (EPO)、Lenalidomide (尤其針對 del(5q))、Luspatercept (TGF-β 配體陷阱) 等。新一代 TGF-β 配體陷阱 Elritercept (KER-050) 正在臨床試驗中。高度與極高度風險 MDS 治療目標則是延緩進展為 AML 與延長存活，使用低甲基化藥物 (Azacitidine、Decitabine)、合併 Venetoclax 或考慮造血幹細胞移植。",
    },
    {
        slug: "MM",
        nameZh: "多發性骨髓瘤",
        ...
        tagline: "多發性骨髓瘤 (MM) — 漿細胞惡性腫瘤。近年因 BCMA、GPRC5D、CD38 等新一代標靶療法蓬勃發展，治療選項大幅擴展。",
    ...
    },
    {
        ...
        tagline: "骨髓增生性腫瘤 (MPN) — 涵蓋骨髓纖維化、原發性血小板增多症、真性紅血球增多症。JAK 抑制劑與新一代藥物持續推進治療進展。",
        ...
        treatmentContext: "JAK 抑制劑 Ruxolitinib 為 MF 與 PV 的主要治療藥物，可改善脾腫大、症狀與整體存活。針對 ET，標準治療包括 Hydroxyurea、Anagrelide。新一代藥物正積極開發：LSD1 抑制劑 Bomedemstat (MK-3543) 在 ET 與 MF 臨床試驗中展現潛力；MDM2 抑制劑 Navtemadlin (KRT-232) 為 Ruxolitinib 反應不佳的 MF 患者提供新選項；BCL-XL 抑制劑 Navitoclax 合併 Ruxolitinib 也在臨床試驗中。",
    },
    {
        slug: "CML",
        nameZh: "慢性骨髓性白血病",
        ...
        tagline: "慢性骨髓性白血病 (CML) — 由酪胺酸激酶抑制劑 (TKI) 大幅改變預後的血液癌症，多數病患可長期穩定控制。",
        ...
        treatmentContext: "酪胺酸激酶抑制劑 (Tyrosine Kinase Inhibitors, TKIs) — 包括第一代 Imatinib、第二代 Dasatinib / Nilotinib / Bosutinib、第三代 Ponatinib，以及 STAMP 抑制劑 Asciminib — 已將 CML 從致命疾病轉變為可長期控制的慢性病。多數慢性期病患可達深度分子緩解 (Deep Molecular Response)，符合條件者甚至可嘗試停藥 (Treatment-Free Remission)。",
        noTrialsMessage: "目前無 CML 招募中的臨床試驗。",
    },
    {
        slug: "ALL",
        nameZh: "急性淋巴性白血病",
        ...
        tagline: "急性淋巴性白血病 (ALL) — 淋巴細胞惡性增生的血液癌症。雙特異性抗體與 CAR-T 細胞療法已大幅改變治療樣貌。",
        ...
        treatmentContext: "雙特異性抗體 Blinatumomab (CD19 × CD3) 已成為 B 細胞 ALL 的重要治療選項，可特異性引導 T 細胞攻擊白血病細胞，副作用相對較輕，特別適合年長或體弱病患。其他新藥包括抗體藥物複合體 Inotuzumab ozogamicin (anti-CD22)、CAR-T 細胞療法 (Tisagenlecleucel) 等。新一代 T 細胞雙特異性抗體 (如 AZD0486) 也在臨床試驗中。",
    },
    {
        slug: "CLL",
        nameZh: "慢性淋巴細胞白血病",
        ...
        tagline: "慢性淋巴細胞白血病 (CLL) — 成人最常見白血病之一。BTK 抑制劑與新一代蛋白降解劑為治療帶來突破。",
        ...
        treatmentContext: "BTK 抑制劑改變了 CLL 治療：共價型 (Ibrutinib、Acalabrutinib、Zanubrutinib)、非共價型 (Pirtobrutinib、Nemtabrutinib) 均已上市或進入臨床試驗；BCL-2 抑制劑 Venetoclax 合併抗 CD20 抗體 (Obinutuzumab) 提供時間限定治療方案。對 BTK 抑制劑失效或無法耐受的病患，新一代 BTK 蛋白降解劑 (如 BGB-16673、NX-5948 Bexobrutideg) 利用蛋白降解機制清除 BTK，提供突破性選項。",
    },
    {
        slug: "Lymphoma",
        nameZh: "淋巴瘤",
        ...
        tagline: "淋巴瘤 (Lymphoma)，俗稱「淋巴癌」 — 涵蓋多種亞型。CD20×CD3 雙特異性抗體與 CAR-T 細胞療法已重新定義治療策略。",
        ...
        treatmentContext: "CD20 × CD3 雙特異性抗體已改變治療策略：Epcoritamab、Odronextamab、AZD0486 (Surovatamig) 等在新診斷與復發/難治型 B 細胞淋巴瘤展現高度療效，部分已在標準治療中佔有一席之地。BTK 抑制劑、CAR-T 細胞療法、抗體藥物複合體 (ADC) 與 EZH2 抑制劑 (Tazemetostat) 也持續推進。針對 T 細胞淋巴瘤，JAK1 抑制劑 (Golidocitinib) 等新藥正在臨床試驗中。",
    },
    {
        slug: "AA",
        nameZh: "再生不良性貧血",
        ...
        treatmentContext: "嚴重 AA 治療有兩大策略：一是異體造血幹細胞移植 (Allogeneic HSCT)，特別適合年輕、有 HLA 相符兄弟姊妹捐贈者的病患；二是免疫抑制治療 (Immunosuppressive Therapy, IST)，標準方案為 anti-thymocyte globulin (ATG) 合併 Cyclosporine，近年加入血小板生成素受體致效劑 Eltrombopag 後，反應率與整體存活均明顯改善。其他支持性治療包括輸血、抗感染藥物、生長因子 (如 G-CSF)。",
        noTrialsMessage: "目前無再生不良性貧血招募中的臨床試驗。",
    },
    {
        slug: "HSCT",
        nameZh: "造血幹細胞移植",
        ...
        tagline: "造血幹細胞移植 (HSCT) — 多種血液疾病的根治性治療。配合精準供者選擇與移植後照護以提升治療成功率。",
        ...
        treatmentContext: "異體移植後最重要的併發症之一是移植物對抗宿主病 (Graft-versus-Host Disease, GVHD)：捐贈者的免疫細胞攻擊受贈者組織，可分為急性 (主要影響皮膚、腸胃道、肝臟) 與慢性 (可影響多個器官，常需長期治療)。一線治療為類固醇，對類固醇難治型 GVHD，新藥已大幅改善預後：JAK 抑制劑 Ruxolitinib 是急性與慢性 GVHD 二線標準治療；Belumosudil (ROCK2 抑制劑) 已上市治療慢性 GVHD；其他選項包括 Ibrutinib、Extracorporeal Photopheresis (ECP) 等。",
    },
    {
        slug: "PNH",
        nameZh: "陣發性夜間血紅素尿症",
        ...
        tagline: "陣發性夜間血紅素尿症 (PNH) — 罕見的後天性溶血性疾病。C5 補體抑制劑已大幅改變治療面貌。",
        ...
        treatmentContext: "C5 補體抑制劑徹底改變了 PNH 治療：Eculizumab（首個 C5 抑制劑）與 Ravulizumab（長效型 C5 抑制劑）可大幅減少溶血、輸血需求與血栓風險，已成為 PNH 標準治療。新一代組合療法（如 Pozelimab 合併 siRNA 藥物 Cemdisiran，雙重抑制 C5 表現與功能）正在臨床試驗中，可能進一步改善療效並提供更便利的給藥方式。",
    },
];
