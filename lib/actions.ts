...
function transformTrial(row: Database['public']['Tables']['trials']['Row']): Trial {
    return {
        ...
        chineseFullTitle: row.chinese_full_title || '',
        irbApprovalNumber: row.irb_approval_number || '',
        mechanismZh: row.mechanism_zh || '',
        eligibilityZh: row.eligibility_zh || '',
        studyDrug: row.study_drug,
        studyDrugZh: row.study_drug_zh || '',
...
export async function createTrial(formData: FormData) {
    ...
    const trialData = {
        ...
        full_title: formData.get('fullTitle') as string,
        chinese_full_title: formData.get('chineseFullTitle') as string,
        irb_approval_number: formData.get('irbApprovalNumber') as string,
        mechanism_zh: formData.get('mechanismZh') as string,
        eligibility_zh: formData.get('eligibilityZh') as string,
        study_drug: formData.get('studyDrug') as string,
        study_drug_zh: formData.get('studyDrugZh') as string,
        mechanism_of_action: formData.get('mechanismOfAction') as string,
